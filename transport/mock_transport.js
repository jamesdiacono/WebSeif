// A WebSeif transport for testing. It simulates a private network in memory.
// Latency is randomised. The 'flakiness' parameter, between 0 and 1, controls
// the propensity for network errors.
...
if (import.meta.main) {
    transport_demo(mock_transport(0), "bob");
}
